...
There are three common ways to select the number of factors:
...
```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE,results='asis'}
NEW_ProjectData <- Rotated_Results$scores[,1:factors_selected,drop=F]
