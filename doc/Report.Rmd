...
Variance_Explained_Table<-cbind(names,Variance_Explained_Table)
colnames(Variance_Explained_Table)<-c("Components", "Eigenvalue", "Percentage of explained variance", "Cumulative percentage of explained variance")
print(gvisTable(as.data.frame(Variance_Explained_Table), options=list(width=1024, height=400,allowHTML=TRUE,page='disable',pageSize=15,showRowNumber=FALSE)),'chart')
```


```{r echo=FALSE, comment=NA, warning=FALSE, message=FALSE,results='asis'}
if (factor_selectionciterion == "eigenvalue")
  factors_selected = which(Variance_Explained_Table_results$eig$eigenvalue > 1)
if (factor_selectionciterion == "variance")
  factors_selected = 1:head(which(Variance_Explained_Table[,"cumulative percentage of variance"]>65),1)
```
