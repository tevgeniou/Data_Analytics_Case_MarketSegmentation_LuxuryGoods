...
<style type="text/css">table,th,tr,thead,tbody,td {font-size:8px; text-align: center;}</style>
...
m1<-gvisTable(dfnew,options=list(showRowNumber=TRUE,width=970, height=400,allowHTML=TRUE,page='disable'))
print(m1,'chart')
```
